...
class ProductionConfig(Config):
    ...
    DB_HOST = os.environ.get('MYSQL_HOST') or Config.DB_HOST
    DB_USER = os.environ.get('MYSQL_USER') or Config.DB_USER
    DB_PASSWORD = os.environ.get('MYSQL_PASSWORD') or Config.DB_PASSWORD
    DB_NAME = os.environ.get('MYSQL_DATABASE') or Config.DB_NAME
    ...
    # Railway volume mount path for images
